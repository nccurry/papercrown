...
# Snapshot token replacing absolute paths under the repository root.
_TOKEN_PAPERCROWN = "<<papercrown>>"
# Snapshot token replacing absolute paths under the fixture root.
_TOKEN_FIXTURE = "<<fixture>>"
# Snapshot token replacing other temporary absolute paths.
_TOKEN_TMP = "<<tmp>>"
