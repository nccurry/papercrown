...
from papercrown.system.dependencies import native_pdf_runtime_diagnostics
from papercrown.system.diagnostics import (
    Diagnostic,
    DiagnosticReport,
    DiagnosticSeverity,
)
from papercrown.system.export import Tools, discover_tools, ensure_exports_fresh

LogFn = Callable[[str], None]
# Filler shapes expected to have alpha-friendly transparent edges.
_TRANSPARENT_FILLER_SHAPES = {"spot", "small-wide", "plate", "bottom-band"}
# Expected art-role categories for each filler shape.
...
# Alpha value considered fully opaque for edge/corner checks.
_OPAQUE_ALPHA = 245
# Alpha value considered visible enough to prove an image has content.
_MIN_VISIBLE_ALPHA = 0
# Alpha cutoff used when measuring non-transparent filler extents.
_VISIBLE_ALPHA = 16
