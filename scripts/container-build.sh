...
args=(
  --file Dockerfile
  --pull
  --build-arg "UV_BASE_IMAGE=${UV_BASE_IMAGE:-ghcr.io/astral-sh/uv:0.11.8-python3.14-trixie-slim}"
  --build-arg "PYTHON_RUNTIME_IMAGE=${PYTHON_RUNTIME_IMAGE:-python:3.14-slim-trixie}"
